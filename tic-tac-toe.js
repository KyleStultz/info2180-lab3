    ...
    for (let square of squares){
        ...
        square.onclick = (event)=>{
            ...
            if ( state[0] !== undefined && ((state[0]===state[1] && state[1]===state[2]) 
                ...
                status. innerHTML = `Congratulations! ${state[0]} is the Winner!`;
                ...
                status. innerHTML = `Congratulations! ${state[4]} is the Winner!`;
                status.classList.add('you-won');
                GameEndCheck = true;
                ...
                status. innerHTML = `Congratulations! ${state[8]} is the Winner!`;
                status.classList.add('you-won');
                GameEndCheck = true;
